...
#if !DGUS_UI_IS(NONE) || ENABLED(ANYCUBIC_LCD_KOBRA)
...
#if ANY(HAS_DGUS_LCD, MALYAN_LCD, ANYCUBIC_LCD_I3MEGA, ANYCUBIC_LCD_CHIRON, NEXTION_TFT, TOUCH_UI_FTDI_EVE, ANYCUBIC_LCD_KOBRA)
