...
#define STRING_CONFIG_H_AUTHOR "(Fabian, Custom Build)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_TRIGORILLA_PRO_A_V104
#endif
...
#define CUSTOM_MACHINE_NAME "Custom Anycubic Kobra Plus"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 100, 400, 411.17 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1300, 1200, 100, 10000 }
...
#define XY_PROBE_FEEDRATE (133*66)
...
#define Z_CLEARANCE_FOR_HOMING  12     // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
                                      // You'll need this much clearance above Z_MAX_POS to avoid grinding.

#define Z_AFTER_HOMING          12   // (mm) Height to move to after homing (if Z was homed)
